        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="relative h-[500px] w-full bg-gray-900 overflow-hidden">
                <img
                    ...
                    onError={(e) => {
                        e.target.src = 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?ixlib=rb-4.1.0&auto=format&fit=crop&w=1920&q=80';
                    }}
                />
                ...
                <div className="absolute bg-black/50 inset-0 flex items-center justify-center">
                    <div className="w-full max-w-2xl px-4 text-center">
                        ...
                        <div className="relative max-w-md mx-auto">
                            ...
                            />
                            <button className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-orange-500 text-white p-2 rounded-full hover:bg-orange-600 transition-all">
